...
implements ProxyData
{
    ...
    public Socket openConnection(String hostname, int port, int connectTimeout, int readTimeout) throws IOException {
		...
		SkStatus.logInfo("<strong>" + mContext.getString(R.string.state_proxy_running)+"</strong>");
		...
		SkStatus.logInfo("<strong></font><font color=\"#005db6\">" + mContext.getString(R.string.state_proxy_inject) + "</strong>");
